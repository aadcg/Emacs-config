...
* COMMENT
** dotfiles
- how to have org latest version installed?
- need to create backups folder
- pdf tools gnu install emacs-pdf-tools

Tasks:

- [ ] virtual machine (personal laptop or work laptop?)
- [ ] firefox dotfiles?
- [X] add termux dotfiles
- [X] change emacs repo to dotfiles and stow
- [ ] git config file
...
- [ ] +Paromtv+
- [ ] Termux dotfiles
- [ ] packages (guix package --list-installed)
...
[[https://vxlabs.com/2014/06/06/configuring-emacs-mu4e-with-nullmailer-offlineimap-and-multiple-identities/][here]]
...
** Eshell docs
[[https://github.com/howardabrams/dot-files/blob/master/emacs-eshell.org][link]]
[[https://www.masteringemacs.org/article/complete-guide-mastering-eshell][link2]]

** Italics in org-mode
[[https://superuser.com/questions/439159/underline-instead-of-italic-in-org-mode][possible fix]]
