...
#+begin_src emacs-lisp
  ...
  (use-package modus-operandi-theme
    ...
    :config
    ;; (setq custom-theme-load-path "/home/aadcg/repos/modus-themes")
...
#+begin_src emacs-lisp
  ...
  (defun auto-size-font (n)
    ...
    (let ((size 10))
      ...
      (while (> (window-max-chars-per-line) (* n 82))
        (setq size (1+ size))
        (set-frame-font (concat "Fira Code " (number-to-string size)) nil t))
      (message "The suggested font size is %d" size)))

  ;; (set-frame-font "Fira Code-10:antialias=true")
#+end_src
...
#+begin_src emacs-lisp
  (use-package eshell
    ...
    ;; :commands eshell-visual-commands
    :hook
...
#+begin_src emacs-lisp
  (use-package password-cache
    :custom (password-cache-expiry 3600))
#+end_src
...
#+begin_src emacs-lisp
  (use-package pdf-tools
    ...
    (
     ...
     (pdf-view-mode-hook . pdf-link-minor-mode)
