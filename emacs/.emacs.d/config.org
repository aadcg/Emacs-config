...
#+begin_src emacs-lisp
  (use-package holidays
    :custom
    ;; this is just a fix since calendar-holidays is autoloaded
...
#+begin_src emacs-lisp
  (use-package solar
    ;; :config
    ;; (defvar porto '(41.16 -8.63 "Porto, Portugal"))
    ;; (defvar piter '(59.94 30.31 "Санкт-Петербург, Россия"))

    ;; (defun set-calendar (location-alist)
    ;;   "Sets lat, lon and location name.")
    :custom
...
#+begin_src emacs-lisp
  (use-package slime
    :custom (slime-port 4006))

  (use-package slime-company
    :config (slime-setup '(slime-company)))

  ;; (use-package sly
  ;;   :custom (inferior-lisp-program "/gnu/store/pfbkk46qg5fk0h5vmpzjff20i1ddy781-profile/bin/sbcl"))
