...
#+begin_src emacs-lisp
  (use-package modus-operandi-theme
    ...
    (run-at-time (nth 1 (split-string (sunrise-sunset)))
                 (* 60 60 24)
                 (lambda () (counsel-load-theme-action "modus-operandi")))
    ...
    (defun my-match-sway-bar-with-theme ()
    "Change swaybar colors according to theme."
  ...
  (use-package modus-vivendi-theme
    ...
    (run-at-time (nth 4 (split-string (sunrise-sunset)))
                 (* 60 60 24)
                 (lambda () (counsel-load-theme-action "modus-vivendi"))))
#+end_src
...
#+begin_src emacs-lisp
  (use-package dired
    ...
    (setq dired-recursive-copies 'always
          ...
          dired-listing-switches "-Atrhlb --group-directories-first"
...
#+begin_src emacs-lisp
  ...
  (add-hook 'input-method-activate-hook
            (lambda () (change-to-dict "ru")))

  (add-hook 'input-method-deactivate-hook
            (lambda () (change-to-dict "en")))
#+end_src
