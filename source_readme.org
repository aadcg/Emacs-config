...
# [![Build
# Status](https://travis-ci.org/aadcg/.emacs.d.svg?branch=master)](https://travis-ci.org/aadcg/.emacs.d)
#+html: https://api.travis-ci.com/aadcg/.emacs.d.svg
#+html: <a href="https://gitlab.com/aadcg/hello_world/commits/master"><img alt="pipeline status" src="https://gitlab.com/aadcg/hello_world/badges/master/pipeline.svg"/></a>
