...
(setq exwm-input-global-keys
      `(([?\s-r] . exwm-reset)
        ...
        ([?\s-l] . (lambda () (interactive) (start-process "" nil "xlock")))
...
(add-hook 'exwm-init-hook (lambda () (start-process
                                 "feh" nil "feh"
                                 "--no-fehbg" "--bg-fill"
                                 "'/home/aadcg/dotfiles/wallpaper'")))
...
(use-package desktop-environment
  ...
  ;; (desktop-environment-screenlock-command "xlock")
  :config
