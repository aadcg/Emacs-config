...
#+BEGIN_SRC emacs-lisp
  (use-package magit
    :config
    ;; (setq exec-path (append exec-path '("/ifs/opt/app/git/2.8.1-gcc/bin")))
    (drf/append-to-path "/ssh:aadco@login.mindstorm.vestas.net:/ifs/opt/app/git/2.8.1-gcc/bin/git")
    ;; (drf/append-to-path "/ifs/opt/app/git/2.8.1-gcc/bin/git")
    :bind
    ("C-x g" . magit-status))
#+END_SRC
* Python
#+BEGIN_SRC emacs-lisp
  ...
  ;; (setenv "WORKON_HOME" "/ssh:aadco@login.mindstorm.vestas.net:/ifs/home/aadco/venv/pse2")
  (drf/append-to-path "/ssh:aadco@login.mindstorm.vestas.net:/ifs/opt/app/anaconda/2-5.1.0/bin")
  ;; (drf/append-to-path "/ssh:aadco@login.mindstorm.vestas.net:/ifs/home/aadco/venv/pse2/bin/ipython")
