...
#+begin_src emacs-lisp :results silent
  ...
  ;; (show-paren-mode t) curently using smartparens for this
...
#+begin_src emacs-lisp :results silent
  (use-package org
    ...
    (add-to-list 'org-structure-template-alist
                 '("el" . "src emacs-lisp :results sillent"))
    ...
    ;; (add-to-list 'org-structure-template-alist '("ab" . "abstract"))
    ;; (add-to-list 'org-structure-template-alist '("lx" . "latex"))
...
#+begin_src emacs-lisp :results silent
  ...
  (use-package org-tree-slide
    ...
    (org-tree-slide-play . command-log-mode)
    (org-tree-slide-stop . command-log-mode))
    :bind
